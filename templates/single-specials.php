    ...
    <div class="specials-single">
        <?php while (have_posts()) : the_post(); ?>
            ...
            <?php endif; ?>
                ...
                <div class="special-information-block">
              ...
              <div class="item-wrapper">
                       <a href="#enquiry-form" class="cta-btn">Enquire Now <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;width: 20px;height: 20px;" xml:space="preserve" class="">
                      <g>
