           ...
           <?
            ...
            <div class="esp-specials-grid">
                ...
                ?>
                    ...
                    <div class="esp-special-card">
                        <div class="esp-special-img-wrapper">
                        <img class="esp-special-img" src="<?php echo $image[0]; ?>">
                        ...
                        <div class="esp-special-content-wrapper">
                            
                                 <!-- Information Block Start -->
                 
                        <div class="esp-special-information-card">
                      ...
                      <div class="esp-item-wrapper">
                               <a href="<?php echo the_permalink()?>" class="esp-cta-btn">View Special Offer<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;width: 20px;height: 20px;" xml:space="preserve" class="">
                              <g>
